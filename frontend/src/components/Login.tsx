        ...
        <div className="flex items-center justify-center min-h-screen p-4 bg-cover bg-center">
            <div className="p-6 sm:p-8 bg-gray-800 bg-opacity-90 rounded-lg shadow-xl w-full max-w-md backdrop-blur-sm border border-gray-700">
                <form onSubmit={handleSubmit} className="space-y-5">
                    {/* Email Input */}
                    <div>
                        <label htmlFor="email" className="block text-xs font-medium text-gray-300 mb-1 uppercase tracking-wider font-minecraft">Email</label>
                        <input
                            type="email"
                            id="email"
                            value={email}
                    ...
                    {/* Password Input */}
                    <div>
                        <label htmlFor="password" className="block text-xs font-medium text-gray-300 mb-1 uppercase tracking-wider font-minecraft">Şifre</label>
                        <input
                            type="password"
                            id="password"
                            value={password}
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full px-4 py-3 text-lg font-bold cursor-grab text-white rounded-sm transition-colors duration-200 font-minecraft uppercase tracking-wider ${isLoading ? 'bg-sky-800 cursor-not-allowed' : 'bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-sky-500'}`}
                    >
